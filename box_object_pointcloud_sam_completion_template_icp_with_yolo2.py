...
from yanjiuyuan.yolo_detect2 import BottleDetector  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    # ---- YOLO 瓶子检测参数 ----
    parser.add_argument("--yolo-model", type=Path, default=Path(__file__).parent / "models" / "bottle_detect2.pt", help="YOLO 瓶子检测模型路径")
